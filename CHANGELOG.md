...
- `nearest_pronunciation` / `PronunciationMatch`: score a form against a set of acceptable variants (a lexicon's several pronunciations, a homograph's two readings) and report the best match and which member won; named for acceptability, not word-to-word distance (#167).
