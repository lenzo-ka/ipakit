...
| Applicability-scoped transcription distance | `transcription_distance`, `directional_transcription_distance`, `transcription_similarity`, `explain_transcription_distance`, `word_distance`, `directional_word_distance`, `word_similarity`, `explain_word_distance`, `nearest_pronunciation`, `rank_pronunciations` with `applicable_only=True` | **CLI-reachable:** `distance transcription --applicable-only`, `distance directional --applicable-only`, and `distance nearest --applicable-only`, including raw and explanation output. |
