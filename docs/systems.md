...
| [Kana](kana.md) | Mora groupings and mora-kind-dependent orthographic realization. | Existing API/CLI and mora-tier renderer cover bounded curated adaptation fixtures. Comprehensive Japanese analysis remains outside this scope. |
