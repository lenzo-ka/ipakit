...
The first three mean “an intervocalic nasal”, “word-final `t`”, and “a high
...
constraint spellings of `ˈa`, `ã`, and `t̚`; `n{place=α}` additionally exposes
the captured place value in `Match.bindings`.
