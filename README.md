...
ipakit.nearest_phones("p", n=3) # [('ɸ', 0.007), ('f', 0.013), ('ʘ', 0.015)]
...
ipakit.normalized_distance("p", "b")  # 0.100   percentile within bundled IPA
ipakit.normalized_distance("p", "a")  # 0.428
ipakit.confusability("p", "b")        # 0.900   complement of normalized_distance
```
